...
- (void)preparePegIn:(NSString *)paramsJson resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject NS_SWIFT_NAME(preparePegIn(_:resolve:reject:));
